...
function driverSample(sample) {
	...
	if (passengerGenes.length >= 2) {
		...
		} else if (bodyId === "lang-es") {
			passenger2 = "No hay genes impulsores";
		} else if (bodyId === "lang-en") {
			passenger2 = "There are no drivers at all";
		}
		// lang
	}
				...
				if ( shuffledIndices[i] == 0 ) {
					if ( sample == 1 ) {
						...
						if (bodyId === "lang-ca") {
							...
							elementDriver.innerHTML = "El gen " + driverSelected + " del paciente 1 es un gen impulsor";
						} else if (bodyId === "lang-en") {
							elementDriver.innerHTML = "The gene " + driverSelected + " of patient 1 is a driver gene";
						}
						// lang
						...
						if (bodyId === "lang-ca") {
							...
							elementDriver.innerHTML = "El gen " + driverSelected + " del paciente 2 es un gen impulsor";
						} else if (bodyId === "lang-en") {
							elementDriver.innerHTML = "The gene " + driverSelected + " of patient 2 is a driver gene";
						}
						// lang
...
function therapySample(sample) {
	...
	if ( elements.length == 0 ) {
		...
		if (bodyId === "lang-ca") {
			...
			elementDriver.innerHTML = "No se ha encontrado ninguna terapia dirigida contra los genes impulsores alterados en este paciente";
		} else if (bodyId === "lang-en") {
			elementDriver.innerHTML = "No targeted therapy has been found against the altered driver genes in this patient";
		}
		// lang
		...
		if ( therapySample1Winner == 0 || therapySample2Winner == 0 ) {
			...
			if (bodyId === "lang-ca") {
				...
				elementDriver.innerHTML = "El paciente " + sample + " puede recibir " + cleanTherapy + " como tratamiento";
			} else if (bodyId === "lang-en") {
				elementDriver.innerHTML = "The patient " + sample + " can receive " + cleanTherapy + " as a treatment";
			}
			// lang
